...
// Package tests implements execution of LoveBlock JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, dpovp.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/LoveBlock/tests/wiki/Blockchain-Tests-II

   Whnetwork a block is valid or not is a bit subtle, it's defined by presence of
