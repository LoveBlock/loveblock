...
which is the outcome of somnetworking happening in the network as a result of a
...
As a concrete example, consider a simulated network of Loveblock nodes. An
