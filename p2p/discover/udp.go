...
//const Version = 4
const LoveStartVersion = 100
const Version = 100
const LoveStopVersion = 200
...
var (
	...
	errVersion          = errors.New("version is too small")
...
func (req *ping) handle(t *udp, from *net.UDPAddr, fromID NodeID, mac []byte) error {
	...
	if (req.Version < LoveStartVersion) || (req.Version > LoveStopVersion) {
		return errVersion
	}
