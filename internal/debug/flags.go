...
import (
	...
	"github.com/LoveBlock/loveblock/log/term"
	"github.com/LoveBlock/loveblock/metrics"
	"github.com/LoveBlock/loveblock/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. network/*=5,p2p=4)",
		Value: "",
	}
