...
type request struct {
	...
	raw  bool        // Whnetwork this is a raw entry (code) or a trie node
...
// Process injects a batch of retrieved trie nodes data, returning if somnetworking
...
func (s *TrieSync) Commit(dbw lovedb.Putter) (int, error) {
