// Copyright 2018 The loveblock Authors
...
type Database struct {
	diskdb lovedb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb lovedb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch lovedb.Batch) error {
	// If the node does not exist, it's a previously committed node
