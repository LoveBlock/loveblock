...
func newTestLDB() (*lovedb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "lovedb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := lovedb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db lovedb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db lovedb.Database, t *testing.T) {
	const n = 8
