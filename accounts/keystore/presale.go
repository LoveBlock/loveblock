...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/LoveBlock/pynetworksaletool

		pynetworksaletool generates the encryption key from password by
	...
	*/
	...
	networkPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(networkPriv)
	...
	expectedAddr := preSaleKeyStruct.LoveAddr
