...
//
// Keys are stored as encrypted JSON files according to the LoveClient Secret Storage specification.
// See https://github.com/LoveBlock/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whnetwork the event notification loop is running
...
func (ks *KeyStore) SignTx(a accounts.Account, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
	...
	return types.SignTx(tx, types.NewDefaultSigner(chainID), unlockedKey.PrivateKey)
}
...
func (ks *KeyStore) SignTxWithPassphrase(a accounts.Account, passphrase string, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
	...
	return types.SignTx(tx, types.NewDefaultSigner(chainID), key.PrivateKey)
}
...
// ImportPreSaleKey decrypts the given LoveBlock presale wallet and stores
