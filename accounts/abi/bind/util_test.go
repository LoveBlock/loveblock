...
import (
	...
	"github.com/LoveBlock/loveblock/accounts/abi/bind/backends"
...
func TestWaitDeployed(t *testing.T) {
	for name, test := range waitDeployedTests {
		...
		tx, _ = types.SignTx(tx, types.NewDefaultSigner(params.AllLovehashProtocolChanges.ChainId), testKey)
