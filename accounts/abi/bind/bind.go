...
// Package bind generates LoveBlock contract Go bindings.
//
// Detailed usage document and tutorial available on the loveblock Wiki page:
// https://github.com/LoveBlock/loveblock/wiki/Native-DApps:-Go-bindings-to-LoveBlock-contracts
package bind
