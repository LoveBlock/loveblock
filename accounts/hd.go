...
// the `coin_type` 60' (or 0x8000003C) to LoveBlock.
//
// The root path for LoveBlock is m/44'/60'/0'/0 according to the specification
// from https://github.com/LoveBlock/EIPs/issues/84, albeit it's not set in stone
