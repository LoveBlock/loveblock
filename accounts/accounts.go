...
// Package accounts implements high level LoveBlock account management.
package accounts
...
// Account represents an LoveBlock account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // LoveBlock account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain loveblock.ChainStateReader)
