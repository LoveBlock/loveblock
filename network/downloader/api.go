...
// Syncing provides information when this nodes starts synchronising with the LoveBlock network and when it's finished.
...
type SyncingResult struct {
	...
	Status  loveblock.SyncProgress `json:"status"`
}
