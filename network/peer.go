...
// PeerInfo represents a short summary of the LoveBlock sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // LoveBlock protocol version negotiated
...
// 从节点已知状态数据里获取一批随机数据，对应于指定的hashes
...
// 握手
// Handshake executes the network protocol handshake, negotiating version number,
