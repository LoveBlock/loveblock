...
// information related to the LoveBlock protocol such als blocks, transactions and logs.
...
// `network_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/LoveBlock/wiki/wiki/JSON-RPC#network_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with network_getFilterChanges.
//
// https://github.com/LoveBlock/wiki/wiki/JSON-RPC#network_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(loveblock.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of LoveBlock.FilterQuery.
...
//
// https://github.com/LoveBlock/wiki/wiki/JSON-RPC#network_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(loveblock.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/LoveBlock/wiki/wiki/JSON-RPC#network_getlogs
...
//
// https://github.com/LoveBlock/wiki/wiki/JSON-RPC#network_uninstallfilter
...
//
// https://github.com/LoveBlock/wiki/wiki/JSON-RPC#network_getfilterlogs
...
//
// https://github.com/LoveBlock/wiki/wiki/JSON-RPC#network_getfilterchanges
