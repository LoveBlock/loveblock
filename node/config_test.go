...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "loveblock.ipc", false, filepath.Join(os.TempDir(), "loveblock.ipc")},
		{"data", "loveblock.ipc", false, "data/loveblock.ipc"},
		{"data", "./loveblock.ipc", false, "./loveblock.ipc"},
		{"data", "/loveblock.ipc", false, "/loveblock.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "loveblock.ipc", true, `\\.\pipe\loveblock.ipc`},
		{"data", "loveblock.ipc", true, `\\.\pipe\loveblock.ipc`},
		{"data", `\\.\pipe\loveblock.ipc`, true, `\\.\pipe\loveblock.ipc`},
	}
