...
/*
Package node sets up multi-protocol LoveBlock nodes.
...
endpoint to a subset of RPC modules. Node itself offers the "debug", "admin" and "networkClient"
modules.
...
Node also creates the shared store of encrypted LoveBlock account keys. Services can access
