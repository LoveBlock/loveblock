...
// PublicLoveClientAPI offers helper utils
type PublicLoveClientAPI struct {
	stack *Node
}

// NewPublicLoveClientAPI creates a new LoveClientService instance
func NewPublicLoveClientAPI(stack *Node) *PublicLoveClientAPI {
	return &PublicLoveClientAPI{stack}
}

// ClientVersion returns the node name
func (s *PublicLoveClientAPI) ClientVersion() string {
	return s.stack.Server().Name
}

// Sha3 applies the LoveBlock sha3 implementation on the input.
// It assumes the input is hex encoded.
func (s *PublicLoveClientAPI) Sha3(input hexutil.Bytes) hexutil.Bytes {
