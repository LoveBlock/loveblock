...
// Package types contains data types related to LoveBlock consensus.
package types
...
import (
	...
	"github.com/LoveBlock/loveblock/crypto/sha3"
...
// Header represents a block header in the LoveBlock blockchain.
type Header struct {
...
// Block represents an entire block in the LoveBlock blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package network to track
...
// [deprecated by network/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for network protocol, etc.
...
// DecodeRLP decodes the LoveBlock
...
// EncodeRLP serializes b into the LoveBlock RLP block format.
