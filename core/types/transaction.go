...
func deriveSigner(V *big.Int) Signer {
	return NewDefaultSigner(deriveChainId(V))
}
...
// MarshalJSON encodes the networkClient RPC transaction format.
...
// UnmarshalJSON decodes the networkClient RPC transaction format.
...
//
// XXX Rename message to somnetworking less arbitrary?
