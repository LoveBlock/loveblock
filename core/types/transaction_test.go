...
var (
	...
	rightvrsTx, _ = NewTransaction(
		...
		NewDefaultSigner(chainId),
		common.Hex2Bytes("98ff921201554726367d2be8c804a7ff89ccf285ebc57dff8ae4c44b9c19ac4a8887321be575c8095f789dd4c743dfe42c1820f9231f98a962b210e3ac2452a301"),
	)
)

func TestTransactionSigHash(t *testing.T) {
	var signer = NewDefaultSigner(chainId)
	if signer.Hash(emptyTx) != common.HexToHash("c775b99e7ad12f50d819fcd602390467e28141316969f4b57f0626f74fe3b386") {
		t.Errorf("empty transaction hash mismatch, got %x", emptyTx.Hash())
	}
	if signer.Hash(rightvrsTx) != common.HexToHash("fe7a79529ed5f7c3375d06b26b186a8644e0e16c373d7a12be41c62d6042b77a") {
...
func TestRecipientEmpty(t *testing.T) {
	...
	from, err := Sender(NewDefaultSigner(chainId), tx)
	if err != nil {
		t.Error(err)
		t.FailNow()
	}
...
func TestTransactionPriceNonceSort(t *testing.T) {
	...
	signer := NewDefaultSigner(chainId)
...
func TestTransactionJSON(t *testing.T) {
	...
	signer := NewDefaultSigner(common.Big1)
