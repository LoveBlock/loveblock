...
type Context struct {
	...
	// sufficient network to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers network from one account to the other
...
// EVM is the LoveBlock Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) LoveBlock virtual machine
