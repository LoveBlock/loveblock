...
// Package state provides a caching layer atop the LoveBlock state trie.
package state
...
// StateDBs within the LoveBlock protocol are used to store anything
...
//
// Carrying over the balance ensures that Love doesn't disappear.
