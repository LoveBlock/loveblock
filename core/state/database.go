...
// Trie is a LoveBlock Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb lovedb.Putter) error
}
...
func NewDatabase(db lovedb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb lovedb.Putter) error {
