...
// stateObject represents an LoveBlock account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of LoveBlock address of the account
	data     Account
	db       *StateDB
...
// Account is the LoveBlock consensus representation of accounts.
