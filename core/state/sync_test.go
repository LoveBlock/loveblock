...
// account array.
func checkStateAccounts(t *testing.T, db lovedb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db lovedb.Database, root common.Hash) error {
...
func checkStateConsistency(db lovedb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(lovedb.Database), srcRoot)
